export declare type BUILT_IN_LOADERS = 'sync' | 'async-require' | 'async-system';
/**
...
export declare const DEFAULT_OPTIONS: RouterLoaderOptions;
export declare const DEFAULT_RESOURCE_OPTIONS: RouteResourceOptions;
