...
var WebpackResourceLoader = (function () {
    function WebpackResourceLoader(_parentCompilation, collectAssets) {
        if (collectAssets === void 0) { collectAssets = false; }
        this._parentCompilation = _parentCompilation;
        this.collectAssets = collectAssets;
        this._uniqueId = 0;
        this.emittedFiles = {};
        ...
        return new Promise(function (resolve, reject) {
            childCompiler.runAsChild(function (err, entries, childCompilation) {
                ...
                if (childCompilation && childCompilation.errors && childCompilation.errors.length) {
                    ...
                    if (_this.collectAssets) {
                        entries[0].modules.forEach(function (m) {
                            if (m.assets) {
                                Object.keys(m.assets).forEach(function (k) {
                                    _this.emittedFiles[k] = m.assets[k];
                                });
                            }
                        });
                    }
    ...
    WebpackResourceLoader.prototype.getExternalAssets = function () {
        return this.emittedFiles;
    };
    return WebpackResourceLoader;
}());
exports.WebpackResourceLoader = WebpackResourceLoader;
//# sourceMappingURL=webpack-resource-loader.js.map